...
let listOfUnfundedGames = GAMES_JSON.filter (game => game.pledged < game.goal);

// create a string that explains the number of unfunded games using the ternary operator
let displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${numberOfGames} games. Currently, ${listOfUnfundedGames.length} game${listOfUnfundedGames.length === 1 ? '' : 's'} remain${listOfUnfundedGames.length === 1 ? 's' : ''} unfunded. We need your help to fund these amazing games.`;
